...
enum EOBJECTID { OBJ_PLAYER, OBJ_MONSTER, OBJ_TILE, OBJ_ITEM, OBJ_EFFECT, OBJ_BULLET, OBJ_END};
enum OBJECTDIR {
...
enum MONSTERID { MON_GOOMBA, MON_GREENKOOPA, MON_REDKOOPA, MON_MOLE, MON_PIRANHA, MON_END };
enum ITEMID {ITEM_COIN, ITEM_YOSHI, ITEM_MUSH, ITEM_LEV, ITEM_CHECK, ITEM_CLEAR, ITEM_FLOWER, ITEM_END };
enum MARIOSTATE {MARIO_SMALL, MARIO_BIG, MARIO_FLOWER,};
enum PLAYERSTATE {
	IDLE, LOOK_UP, DUCK, WALK, RUN, SKID, PIPE, JUMP, FALL, RUN_JUMP, SPIN_JUMP, SLIDE, KICK, SWIM, VICTORY,
	HOLD_IDLE, HOLD_LOOKUP, HOLD_DUCK, HOLD_WALK, HOLD_RUN, HOLD_JUMP, HOLD_SWIM, DEATH, 
	POWERUP, POWERDOWN, INVINCIBLE, END
};


enum CHANNELID { SOUND_EFFECT, SOUND_BGM, SOUND_POWER, MAXCHANNEL };
